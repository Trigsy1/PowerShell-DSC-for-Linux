...
class nxOMSPerfCounterTestCases(unittest2.TestCase):
    ...
    def testSetPerfCounter_add(self):
    ...
    def testGetPerfCounter_add(self):
        d={'Name':'testPerfCounter', 'HeartbeatIntervalSeconds':600,'PerfCounterObject':[{'InstanceName':'*', 'IntervalSeconds':600, 
            'AllInstances':True, 'PerformanceCounter':['FreeMegabytes','PercentFreeSpace','PercentUsedSpace','PercentFreeInodes',
            'PercentUsedInodes','BytesPerSecond','ReadBytesPerSecond','WriteBytesPerSecond'],
            'ObjectName':'Logical Disk'},{'InstanceName':'*', 'IntervalSeconds':60, 'AllInstances':True,
            'PerformanceCounter':['% Processor Time','% DPC Time','% Idle Time','% Nice Time'],
            'ObjectName':'Processor'}]}
        for perf in d['PerfCounterObject']:
            ...
            perf['ObjectName']=nxOMSPerfCounter.protocol.MI_String(perf['ObjectName'])
        e=copy.deepcopy(d)
        t={'Name':'testPerfCounter', 'HeartbeatIntervalSeconds':600,'PerfCounterObject':[{'InstanceName':'*', 'IntervalSeconds':600,
            'AllInstances':True, 'PerformanceCounter':['FreeMegabytes','PercentFreeSpace','PercentUsedSpace','PercentFreeInodes',
            'PercentUsedInodes','BytesPerSecond','ReadBytesPerSecond','WriteBytesPerSecond'],
            'ObjectName':'Logical Disk'},{'InstanceName':'*', 'IntervalSeconds':60, 'AllInstances':True,
            'PerformanceCounter':['% Processor Time','% DPC Time','% Idle Time','% Nice Time'],
    ...
    def testSetPerfCounter_del(self):
    ...
    def testGetPerfCounter_del(self):
        d={'Name':'testPerfCounter', 'HeartbeatIntervalSeconds':600,'PerfCounterObject':[]}
        for perf in d['PerfCounterObject']:
            perf['PerformanceCounter'] = nxOMSPerfCounter.protocol.MI_StringA(perf['PerformanceCounter'])
            perf['InstanceName']=nxOMSPerfCounter.protocol.MI_String(perf['InstanceName'])
    ...
    def testSetPerfCounter_add_missing_conf_file(self):
    ...
    def testSetGetPerfCounter_add_missing_conf_file(self):
        os.system('rm /etc/opt/microsoft/omsagent/conf/omsagent.conf')
        d={'Name':'testPerfCounter','HeartbeatIntervalSeconds':600,'PerfCounterObject':[{'InstanceName':'*', 'IntervalSeconds':600,
            'AllInstances':True, 'PerformanceCounter':['FreeMegabytes','PercentFreeSpace','PercentUsedSpace','PercentFreeInodes',
            'PercentUsedInodes','BytesPerSecond','ReadBytesPerSecond','WriteBytesPerSecond'],
    ...
    def testGetPerfCounter_add_missing_conf_file(self):
        os.system('rm /etc/opt/microsoft/omsagent/conf/omsagent.conf')
        d={'Name':'testPerfCounter','HeartbeatIntervalSeconds':600,'PerfCounterObject':[{'InstanceName':'*', 'IntervalSeconds':600,
            'AllInstances':True,'PerformanceCounter':['FreeMegabytes','PercentFreeSpace','PercentUsedSpace','PercentFreeInodes',
            'PercentUsedInodes','BytesPerSecond','ReadBytesPerSecond','WriteBytesPerSecond'],
    ...
    def testTestPerfCounter_add_missing_conf_file(self):
        os.system('rm /etc/opt/microsoft/omsagent/conf/omsagent.conf')
        d={'Name':'testPerfCounter','HeartbeatIntervalSeconds':600,'PerfCounterObject':[{'InstanceName':'*', 'IntervalSeconds':600,
            'AllInstances':True,'PerformanceCounter':['FreeMegabytes','PercentFreeSpace','PercentUsedSpace','PercentFreeInodes',
            'PercentUsedInodes','BytesPerSecond','ReadBytesPerSecond','WriteBytesPerSecond'],
...
class nxOMSAgentNPMConfigTestCases(unittest2.TestCase):
    ...
    def setUp(self):
        ...
        self.contents = base64.b64encode(b'<Configuration></Configuration>').decode('utf-8')
        self.content_checksum = hashlib.md5(self.contents.encode('utf-8')).hexdigest()
    ...
    def testGetUpdateAgentConfig(self):
        ...
        self.assertTrue(check_values(r,self.make_MI([0], self.config_type, self.config_id, base64.b64decode(self.contents.encode('utf-8')).decode('utf-8'), self.ensure_present, self.content_checksum)) == True,'nxNPMD.Get_Marshall(self.config_type, self.config_id, self.contents, self.ensure_present, self.content_checksum)[0] should return == 0')
    ...
    def testTestUpdateConfigChecksumMismatch(self):
        ...
        r=nxNPMD.Test_Marshall(self.config_type, self.config_id, base64.b64encode(b'New config string').decode('utf-8'), self.ensure_present, self.content_checksum)
    ...
    def testTestUpdateNewConfig(self):
        ...
        newChecksum = hashlib.md5(base64.b64encode(newContent.encode('utf-8'))).hexdigest()
        r=nxNPMD.Test_Marshall(self.config_type, self.config_id, base64.b64encode(newContent.encode('utf-8')).decode('utf-8'), self.ensure_present, newChecksum)
        self.assertTrue(r == [-1],'nxNPMD.Test_Marshall(self.config_type, self.config_id, self.contents, self.ensure_present, self.content_checksum) should return == -1')
    ...
    def testTestSolutionEnable(self):
        ...
        with open(nxNPMD.CONFIG_PATH.__add__(nxNPMD.DEST_FILE_NAME), 'w+') as dFile:
            dFile.write(base64.b64decode(self.contents.encode('utf-8')).decode('utf-8'))
    ...
    def testSetNewAgentConfig(self):
        ...
        self.assertTrue(content == base64.b64decode(self.contents.encode('utf-8')).decode('utf-8'), 'Contents written to file do not match')

    def testSetUpdateConfigChecksumMismatch(self):
        # disables check for binary update
        nxNPMD.AGENT_RESOURCE_VERSION_PATH = '/var/tmp/etc/opt/microsoft/omsagent/VERSION'
        newStr = 'New config string'
        r=nxNPMD.Set_Marshall(self.config_type, self.config_id, base64.b64encode(newStr.encode('utf-8')).decode('utf-8'), self.ensure_present, self.content_checksum)
    ...
    def testSetUpdateNewConfig(self):
        ...
        newContent = 'New config string'
        newChecksum = hashlib.md5(base64.b64encode(newContent.encode('utf-8'))).hexdigest()
        r=nxNPMD.Set_Marshall(self.config_type, self.config_id, base64.b64encode(newContent.encode('utf-8')).decode('utf-8'), self.ensure_present, newChecksum)
        self.assertTrue(r == [0],'nxNPMD.Set_Marshall(self.config_type, self.config_id, self.contents, self.ensure_present, self.content_checksum) should return == 0')
        content = self.readFile(self.out_file)
